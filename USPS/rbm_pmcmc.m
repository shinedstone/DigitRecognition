...
%             
%             %%%%%%%%% UPDATE WEIGHTS AND BIASES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%             vishidinc = 10*epsilonw*(posprods/numcases-negprods/nchain);
%             visbiasinc = 10*epsilonvb*(posvisact/numcases-negvisact/nchain);
%             hidbiasinc = 10*epsilonhb*(poshidact/numcases-neghidact/nchain);
%             labhidinc = 10*epsilonw*(poslabprods/numcases-neglabprods/nchain);
%             labbiasinc = 10*epsilonvb*(poslabact/numcases-neglabact/nchain);
%             
%             vishid = vishid - vishidinc;
%             visbiases = visbiases - visbiasinc;
%             hidbiases = hidbiases - hidbiasinc;
...
%     end
    ...
    if rem(epoch,100) == 0
        RBMClassification = [ RBMClassification calculate_classification_usps(vishid,hidbiases,visbiases,labhid,labbiases,testbatchdata,testbatchtarget); ];
        figure(4);
