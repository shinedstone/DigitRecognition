...
for epoch = 1:maxepoch
    ...
    for batch = 1:numbatches
        ...
        labhidinc = poslabprods/numcases-neglabprods/nchain;
        labbiasinc = poslabact/numcases-neglabact/nchain;
        
        vishid = vishid + epsilonw*vishidinc;
        visbiases = visbiases + epsilonvb*visbiasinc;
        hidbiases = hidbiases + epsilonhb*hidbiasinc;
        labhid = labhid + epsilonw*labhidinc;
        labbiases = labbiases + epsilonvb*labbiasinc;
